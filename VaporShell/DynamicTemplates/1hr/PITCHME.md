...
<h5>[@fa[pencil] ferrell.io](https://ferrell.io/)<br>[@fa[twitter] @scrthq](https://twitter.com/scrthq)<br>[@fa[github] @scrthq](https://github.com/scrthq)<br>[@fa[slack] @scrthq](https://aka.ms/PSSlack)<br>[@fa[discord] @scrthq](https://aka.ms/PSDiscord)</h5>
@snapend
